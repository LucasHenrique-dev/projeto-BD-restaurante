...
--
-- Temporary view structure for view `dataclientesdodia`
--

DROP TABLE IF EXISTS `dataclientesdodia`;
/*!50001 DROP VIEW IF EXISTS `dataclientesdodia`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `dataclientesdodia` AS SELECT 
 1 AS `data`,
 1 AS `clientesNoDia`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `maiorescontas`
--

DROP TABLE IF EXISTS `maiorescontas`;
/*!50001 DROP VIEW IF EXISTS `maiorescontas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `maiorescontas` AS SELECT 
 1 AS `IDPagamento`,
 1 AS `desconto`,
 1 AS `tipoPagamento`,
 1 AS `PrecoPago`*/;
...
--
-- Temporary view structure for view `pratosmaispedidos`
--

DROP TABLE IF EXISTS `pratosmaispedidos`;
/*!50001 DROP VIEW IF EXISTS `pratosmaispedidos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `pratosmaispedidos` AS SELECT 
 1 AS `IDPrato`*/;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `produtoprato` VALUES (7,1),(13,2),(19,2),(13,4),(30,4),(31,4),(32,4),(31,5),(15,6),(28,8),(15,9),(27,10),(30,10),(32,11),(2,13),(8,13),(16,13),(1,14),(4,14),(19,14),(25,16),(29,20),(27,21),(25,24),(16,25),(1,26),(25,27),(1,30),(5,30),(13,30),(8,33);
/*!40000 ALTER TABLE `produtoprato` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `qtdpratospedidos`
--

DROP TABLE IF EXISTS `qtdpratospedidos`;
/*!50001 DROP VIEW IF EXISTS `qtdpratospedidos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `qtdpratospedidos` AS SELECT 
 1 AS `IDPrato`,
 1 AS `vezesPedido`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `qtdprodutosfornecedores`
--

DROP TABLE IF EXISTS `qtdprodutosfornecedores`;
/*!50001 DROP VIEW IF EXISTS `qtdprodutosfornecedores`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `qtdprodutosfornecedores` AS SELECT 
 1 AS `produtosFornecidos`,
 1 AS `fornecedor`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `dataclientesdodia`
--
...
/*!50001 VIEW `dataclientesdodia` AS select `pedido`.`data` AS `data`,count(`pedido`.`IDpagamento`) AS `clientesNoDia` from `pedido` group by `pedido`.`data` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `maiorescontas`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `maiorescontas` AS select `pg`.`IDPagamento` AS `IDPagamento`,`pg`.`desconto` AS `desconto`,`pg`.`tipoPagamento` AS `tipoPagamento`,round((sum(`pp`.`Preço Bruto`) * (1 - (`pg`.`desconto` / 100))),2) AS `PrecoPago` from ((`pedido` `p` join `pedidoprecos` `pp`) join `pagamento` `pg`) where ((`p`.`IDpagamento` = `pg`.`IDPagamento`) and (`pp`.`IDPedido` = `p`.`IDPedido`)) group by `pg`.`IDPagamento` having (`PrecoPago` > 250) order by `pg`.`IDPagamento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `pratosmaispedidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pratosmaispedidos` AS select `qtdpratospedidos`.`IDPrato` AS `IDPrato` from `qtdpratospedidos` where `qtdpratospedidos`.`vezesPedido` in (select max(`qtdpratospedidos`.`vezesPedido`) from `qtdpratospedidos`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `qtdpratospedidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `qtdpratospedidos` AS select `pedidoprato`.`IDPrato` AS `IDPrato`,sum(`pedidoprato`.`quantidade`) AS `vezesPedido` from `pedidoprato` where (`pedidoprato`.`data` = '2022-10-10') group by `pedidoprato`.`IDPrato` order by `vezesPedido` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `qtdprodutosfornecedores`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `qtdprodutosfornecedores` AS select count(`produto`.`nome`) AS `produtosFornecidos`,`produto`.`fornecedor` AS `fornecedor` from `produto` group by `produto`.`fornecedor` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-10-24  1:50:53
